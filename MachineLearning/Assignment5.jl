...
Gray.(permutedims(reshape(train_x[:,:,:,rand(1:end)], 28, 28), (2,1)))
...
begin
	train = ([(train_x[:,:,:,i], labels2[:,i]) for i in partition(1:59000, 1000)]) |> 	gpu
	valset = 59001:60000
...
Gray.(permutedims(reshape(test_x[:,:,:,image_index], 28, 28), (2,1)))
...
begin
	using DataFrames
	DataFrame(accuracy=(class_correct ./ class_total), label=0:9)
end
...
julia_version = "1.9.4"
manifest_format = "2.0"
project_hash = "ab876212161f346c5b7405557f3b95ebaa2cc1bb"
