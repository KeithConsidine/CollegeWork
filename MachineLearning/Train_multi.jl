...
begin
	...
	hyperparameters = Dict(
	    ...
	    "nlabels" => 5,
	    "pdrop" => 0.75, # increased to 0.75
	    "dim_embedding" => 128 # increase to 128
	)
	nlabels = hyperparameters["nlabels"]
	n_epochs = 1 # decreased to 1 because my system is too slow but on 10 epochs the score is better
end;
...
begin
	...
	model = TransformersLite.TransformerClassifier(
	    ...
	    TransformerEncoderBlock[
			...
			TransformerEncoderBlock(4, dim_embedding, dim_embedding * 4;
